...
while {true} do
{
    ...
    _bankString = format ["<t color='#dddddd' shadow='1' shadowColor='#000000' align='right' size='1.2'>%1<img size='1' image='assets\image\austral.paa'/></t>", [profileNamespace getVariable ["uk_var_cashInBank", 0]] call fnc_formatNumber];
    _handString = format ["<t color='#ffffff' shadow='1' shadowColor='#000000' align='right' size='1.2'>%1<img size='1' image='assets\image\austral.paa'/></t>", [profileNamespace getVariable ["uk_var_cashOnHand", 0]] call fnc_formatNumber];
