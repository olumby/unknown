 ...
 * 
 * @usage nul = [my_object] execVM "external\R3F_LOG\USER_FUNCT\do_not_lose_it.sqf";
 * @usage nul = [my_object, "spawn_pos"] execVM "external\R3F_LOG\USER_FUNCT\do_not_lose_it.sqf";
 * @usage nul = [my_object, "cargo_pos"] execVM "external\R3F_LOG\USER_FUNCT\do_not_lose_it.sqf";
 * @usage nul = [my_object, "<marker name>"] execVM "external\R3F_LOG\USER_FUNCT\do_not_lose_it.sqf";
 * 
