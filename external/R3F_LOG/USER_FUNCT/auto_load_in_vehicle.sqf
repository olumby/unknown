 ...
 * @usage nul = [my_vehicle, [my_object1, my_object2] ] execVM "external\R3F_LOG\USER_FUNCT\auto_load_in_vehicle.sqf";
 * 
 * @usage The following command spawns and loads one "Box_IND_Ammo_F" and one "Box_IND_Grenades_F" into my_vehicle
 * @usage nul = [my_vehicle, ["Box_IND_Ammo_F", "Box_IND_Grenades_F"] ] execVM "external\R3F_LOG\USER_FUNCT\auto_load_in_vehicle.sqf";
 * 
 * @usage The following command spawns and loads two "Box_IND_Ammo_F" and one "Box_IND_Grenades_F" into my_vehicle
 * @usage nul = [my_vehicle, [ ["Box_IND_Ammo_F", 2], "Box_IND_Grenades_F" ] ] execVM "external\R3F_LOG\USER_FUNCT\auto_load_in_vehicle.sqf";
 * 
 * @usage The following command loads my_object1, two "Box_IND_Ammo_F" and one "Box_IND_Grenades_F" into my_vehicle
 * @usage nul = [my_vehicle, [ my_object1, ["Box_IND_Ammo_F", 2], "Box_IND_Grenades_F" ] ] execVM "external\R3F_LOG\USER_FUNCT\auto_load_in_vehicle.sqf";
 * 
