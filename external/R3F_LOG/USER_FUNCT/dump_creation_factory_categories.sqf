 ...
 * @usage nul = [] execVM "external\R3F_LOG\USER_FUNCT\dump_creation_factory_categories.sqf";
 * 
 * @usage to not dump the comments after the class names, set the optional param 0 to false
 * @usage nul = [false] execVM "external\R3F_LOG\USER_FUNCT\dump_creation_factory_categories.sqf";
 * 
 * @usage to dump all categories, including empty ones, set param 1 to true
 * @usage nul = [true, true] execVM "external\R3F_LOG\USER_FUNCT\dump_creation_factory_categories.sqf";
 */
