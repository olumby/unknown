 ...
 * @usage execVM "external\R3F_LOG\addons_config\logistics_config_maker_tool\launch_config_tool.sqf";
 * 
...
player addAction ["Dump config to RPT", "external\R3F_LOG\addons_config\logistics_config_maker_tool\dump_config.sqf"];
