 ...
 * Make a copy of this file and fill it. Then add a #include to this file in the file external\R3F_LOG\config.sqf.
 * 
 ...
 * Faites une copie de ce fichier et remplissez-le. Puis ajouter un #include vers celui-ci dans le fichier external\R3F_LOG\config.sqf.
 * 
